    ...
    return (
      <div className={`flex-1 flex flex-col rounded-lg overflow-hidden border border-zinc-200 dark:border-zinc-700 relative isolate z-0${fullscreen ? " min-h-0" : ""}`}>
        <div className={`${
          ...
          {/* EOO/AOO is fullscreen-only for the same reason: it is measured
              over the record layers you switch on, and choosing between them
              is work the dashboard's map has no room for. */}
          ...
          <div className="p-2 bg-white dark:bg-zinc-900 rounded-lg border border-zinc-200 dark:border-zinc-700">
            <div className="flex flex-wrap items-center gap-2">
              ...
              <div className="ml-auto flex items-center gap-1.5 shrink-0">
                    ...
                    {/* Editing tools, on the page that has something to edit.
                        Undo, redo and the CSV import all act on the record list
                        — correcting a coordinate, striking a record out, laying
                        a point file over the map — and that list only exists in
                        fullscreen. On the dashboard they were three controls
                        for work you can't start there. */}
                    {fullscreen && (
                      <>
