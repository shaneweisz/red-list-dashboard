...
// (owns its own pagination + view-mode state for render isolation)
const AssessmentYearsChart = dynamic(
  () => import("./AssessmentYearsChart"),
  { ssr: false, loading: () => <div className="h-full animate-pulse bg-zinc-200 dark:bg-zinc-800 rounded" /> }
);
    ...
    <div className="space-y-4 min-w-0">
      ...
      <div className="space-y-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <AssessmentYearsChart
              loading={speciesLoading && assessedSpecies.length === 0}
              isSingleSpecies={isSingleSpecies}
              singleSpecies={singleSpecies}
              rangeData={assessmentYearData}
              yearData={assessmentYearsByYearData}
              selectedYearRanges={selectedYearRanges}
              selectedAssessmentYears={selectedAssessmentYears}
              onYearRangeClick={handleYearClick}
              onAssessmentYearClick={handleAssessmentYearClick}
            />
          </div>
          )}
