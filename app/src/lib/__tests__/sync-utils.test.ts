...
describe("buildSpeciesIndex", () => {
  const rows: ExistingSpecies[] = [
    { id: 1, scientific_name: "Panthera leo", sis_taxon_id: 100, gbif_species_key: 200 },
    { id: 2, scientific_name: "Homo sapiens", sis_taxon_id: null, gbif_species_key: 300 },
    { id: 3, scientific_name: "Felis catus", sis_taxon_id: 400, gbif_species_key: null },
  ];
...
describe("findMatch", () => {
  const rows: ExistingSpecies[] = [
    { id: 1, scientific_name: "Panthera leo", sis_taxon_id: 100, gbif_species_key: 200 },
    { id: 2, scientific_name: "Puma concolor", sis_taxon_id: null, gbif_species_key: 300 },
    { id: 3, scientific_name: "Felis catus", sis_taxon_id: 400, gbif_species_key: null },
  ];
  ...
  it("falls through to name when primary ID not found", () => {
    const result = findMatch(index, {
