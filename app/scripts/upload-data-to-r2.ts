...
async function main(): Promise<void> {
  ...
  console.log("  git add app/latest-sync.txt app/data/taxa-summary.json app/data/table1a-children-summaries.json app/data/ssc-group-children-summaries.json");
