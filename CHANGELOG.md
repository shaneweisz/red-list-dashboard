...
- Renamed the species detail panel's Red List tab to **IUCN Red List Assessments**, and dropped its Habitats / Threats / Conservation Actions code lists — the IUCN Red List page the tab already links to is the place to read the full classifications
