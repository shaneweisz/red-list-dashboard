...
- **`aohi`** (backs `cc_aohi`, see §3): not bespoke to CoordinateCleaner after all — Park et al. deposited it themselves on Dryad/Zenodo under CC0, independent of the GPL-3 package. Candidate reference data for a phase 4, sourced from that deposit rather than CoordinateCleaner's bundled copy.
