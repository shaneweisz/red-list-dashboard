...
| `cc_sea` | Terrestrial point falls in the ocean | Natural Earth land polygons | **Ported** (phase 3) — 127 polygons, Natural Earth 110m land layer, see §4 |
...
- **Land/sea mask** (phase 3, shipped): Natural Earth 1:110m land layer, via the martynafford mirror — 127 polygons, coordinates rounded to ~110m precision to cut bundle size (237KB → 90KB). Public domain, no CoordinateCleaner dependency.
